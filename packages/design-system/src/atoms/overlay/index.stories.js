...
export const DefaultActive = {
  ...
  play({ canvasElement }) {
    ...
    expect(overlay).toHaveStyle("display: block; position: fixed; top: 0; right: 0; bottom: 0; left: 0;");
  }
};
...
export const TypeContentActive = {
  ...
  play({ canvasElement }) {
    ...
    expect(overlay).toHaveStyle("display: block; position: absolute; top: 0; left: 0;");
  }
};
