...
const d = (e) => typeof window < "u" ? window.btoa(e) : Buffer.from(e, "utf-8").toString("base64"), f = /* @__PURE__ */ new Map(), g = ({ width: e, height: r, color: t }) => {
  const o = `${e},${e},${t}`;
...
function C({
  ...
  return Object.keys(m).forEach((c) => {
    const n = m[c];
    n && (c === "color" && (l = g({ width: a, height: s, color: n })), ["dataURL", "URL"].includes(c) && (l = n));
  }), /* @__PURE__ */ x(
    "img",
    {
      alt: e,
